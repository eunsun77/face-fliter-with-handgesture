...
filters_config = {
    ...
    'anime':
        [{'path': "filters/anonymous1.png",
         'anno_path': "filters/anonymous_annotations1.csv",
         'morph': True, 'animated': False, 'has_alpha': True}],
    'dog':
        [{'path': "filters/anonymous2.png",
         'anno_path': "filters/anonymous_annotations2.csv",
         'morph': False, 'animated': False, 'has_alpha': True},
         {'path': "filters/anonymous3.png",
          'anno_path': "filters/anonymous_annotations3.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
    'cat':
        [{'path': "filters/anonymous4.png",
         'anno_path': "filters/anonymous_annotations4.csv",
         'morph': False, 'animated': False, 'has_alpha': True},
         {'path': "filters/anonymous5.png",
          'anno_path': "filters/anonymous_annotations5.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
}
